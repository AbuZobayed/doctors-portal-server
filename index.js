...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.nqq2a.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`;
...
async function run() {
  try {
     ...
     * app.put('/booking/:id') // upsert as> update (if exists) or insert (if doesn't exist)
     * app.delete('/booking/:id') //
     */

    app.get("/booking", varifyJWT, varifyAdmin, async (req, res) => {
